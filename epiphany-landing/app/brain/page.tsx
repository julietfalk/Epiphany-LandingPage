      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="about-hero-section">
          <div className="about-hero-container">
            <div className="about-hero-layout">
              ...
              >
                <h1 className="about-hero-title">Prime your Brain for Deep Work</h1>
                <p className="about-hero-description">
                  Advanced neurotech headset that primes your brain for optimal focus and flow state
                </p>
              ...
              >
                <img 
                  ...
                  alt="Neurotech headset for brain priming"
        ...
        <section className="benefits-section">
          <div className="benefits-container">
            ...
            >
              <img 
                src="/images/brainbenefits.png" 
                alt="Benefits of brain priming technology"
